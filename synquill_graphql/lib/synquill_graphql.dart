/// A GraphQL adapter package for the Synquill offline-first data engine.
library synquill_graphql;

export 'package:synquill_graphql/src/graphql_batch_options.dart';
export 'package:synquill_graphql/src/graphql_api_adapter.dart';
