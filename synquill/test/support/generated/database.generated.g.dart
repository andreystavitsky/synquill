...
mixin _$ContactDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $ContactTableTable get contactTable => attachedDatabase.contactTable;
}
...
mixin _$IndexingTestProductDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $IndexingTestProductTableTable get indexingTestProductTable =>
      attachedDatabase.indexingTestProductTable;
}
mixin _$IndexingTestCategoryDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $IndexingTestCategoryTableTable get indexingTestCategoryTable =>
      attachedDatabase.indexingTestCategoryTable;
}
mixin _$InvalidProductDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $InvalidProductTableTable get invalidProductTable =>
      attachedDatabase.invalidProductTable;
}
mixin _$TestUserDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $TestUserTableTable get testUserTable => attachedDatabase.testUserTable;
}
mixin _$CategoryDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $CategoryTableTable get categoryTable => attachedDatabase.categoryTable;
}
mixin _$ServerTestModelDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $ServerTestModelTableTable get serverTestModelTable =>
      attachedDatabase.serverTestModelTable;
}
mixin _$ClientTestModelDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $ClientTestModelTableTable get clientTestModelTable =>
      attachedDatabase.clientTestModelTable;
}
mixin _$ServerParentModelDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $ServerParentModelTableTable get serverParentModelTable =>
      attachedDatabase.serverParentModelTable;
}
mixin _$ServerChildModelDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $ServerChildModelTableTable get serverChildModelTable =>
      attachedDatabase.serverChildModelTable;
}
mixin _$DepartmentDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $DepartmentTableTable get departmentTable => attachedDatabase.departmentTable;
}
mixin _$TodoDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $TodoTableTable get todoTable => attachedDatabase.todoTable;
}
mixin _$ProjectDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $ProjectTableTable get projectTable => attachedDatabase.projectTable;
}
mixin _$CompanyDaoMixin on DatabaseAccessor<SynquillDatabase> {
  $CompanyTableTable get companyTable => attachedDatabase.companyTable;
}
...
class $ContactTableTable extends ContactTable
    with TableInfo<$ContactTableTable, Contact> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ContactTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _importedContactIdMeta =
      const VerificationMeta('importedContactId');
  @override
  late final GeneratedColumn<String> importedContactId =
      GeneratedColumn<String>('imported_contact_id', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              requiredDuringInsert: false,
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>($ContactTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns => [
        importedContactId,
        userId,
  ...
  VerificationContext validateIntegrity(Insertable<Contact> instance,
    ...
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('imported_contact_id')) {
      context.handle(
          _importedContactIdMeta,
          importedContactId.isAcceptableOrUnknown(
              data['imported_contact_id']!, _importedContactIdMeta));
    }
  ...
  Contact map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Contact.fromDb(
      ...
      importedContactId: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}imported_contact_id']),
...
class ContactTableCompanion extends UpdateCompanion<Contact> {
  final Value<String?> importedContactId;
  ...
  const ContactTableCompanion({
    this.importedContactId = const Value.absent(),
  ...
  static Insertable<Contact> custom({
    Expression<String>? importedContactId,
    ...
    return RawValuesInsertable({
      if (importedContactId != null) 'imported_contact_id': importedContactId,
  ...
  ContactTableCompanion copyWith(
      {Value<String?>? importedContactId,
      Value<String>? userId,
      Value<String>? id,
    ...
    return ContactTableCompanion(
      importedContactId: importedContactId ?? this.importedContactId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (importedContactId.present) {
      map['imported_contact_id'] = Variable<String>(importedContactId.value);
    }
    if (userId.present) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>(
          $ContactTableTable.$convertersyncStatus.toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  String toString() {
    return (StringBuffer('ContactTableCompanion(')
          ..write('importedContactId: $importedContactId, ')
          ..write('userId: $userId, ')
          ..write('id: $id, ')
...
class $IndexingTestProductTableTable extends IndexingTestProductTable
    with TableInfo<$IndexingTestProductTableTable, IndexingTestProduct> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $IndexingTestProductTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $IndexingTestProductTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, categoryId, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'indexing_test_products';
  @override
  VerificationContext validateIntegrity(
      Insertable<IndexingTestProduct> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  IndexingTestProduct map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return IndexingTestProduct.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
      ...
      lastSyncedAt: attachedDatabase.typeMapping.read(
          DriftSqlType.dateTime, data['${effectivePrefix}last_synced_at']),
      syncStatus: $IndexingTestProductTableTable.$convertersyncStatus.fromSql(
  ...
  @override
  $IndexingTestProductTableTable createAlias(String alias) {
    return $IndexingTestProductTableTable(attachedDatabase, alias);
  }
...
class IndexingTestProductTableCompanion
    extends UpdateCompanion<IndexingTestProduct> {
  final Value<String> id;
  final Value<String> name;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const IndexingTestProductTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
  ...
  IndexingTestProductTableCompanion.insert({
    required String id,
    required String name,
  ...
  static Insertable<IndexingTestProduct> custom({
    Expression<String>? id,
    Expression<String>? name,
  ...
  IndexingTestProductTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return IndexingTestProductTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($IndexingTestProductTableTable
          .$convertersyncStatus
  ...
  @override
  String toString() {
    return (StringBuffer('IndexingTestProductTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
...
class $IndexingTestCategoryTableTable extends IndexingTestCategoryTable
    with TableInfo<$IndexingTestCategoryTableTable, IndexingTestCategory> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $IndexingTestCategoryTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $IndexingTestCategoryTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'indexing_test_categories';
  @override
  VerificationContext validateIntegrity(
      Insertable<IndexingTestCategory> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  IndexingTestCategory map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return IndexingTestCategory.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  $IndexingTestCategoryTableTable createAlias(String alias) {
    return $IndexingTestCategoryTableTable(attachedDatabase, alias);
  }
...
class IndexingTestCategoryTableCompanion
    extends UpdateCompanion<IndexingTestCategory> {
  final Value<String> id;
  final Value<String> name;
  final Value<DateTime?> lastSyncedAt;
  final Value<DateTime?> createdAt;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const IndexingTestCategoryTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.lastSyncedAt = const Value.absent(),
    this.createdAt = const Value.absent(),
  ...
  IndexingTestCategoryTableCompanion.insert({
    required String id,
    required String name,
    this.lastSyncedAt = const Value.absent(),
    this.createdAt = const Value.absent(),
    ...
    this.rowid = const Value.absent(),
        ...
        name = Value(name);
  static Insertable<IndexingTestCategory> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<DateTime>? lastSyncedAt,
    Expression<DateTime>? createdAt,
  ...
  IndexingTestCategoryTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      Value<DateTime?>? lastSyncedAt,
      Value<DateTime?>? createdAt,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return IndexingTestCategoryTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      lastSyncedAt: lastSyncedAt ?? this.lastSyncedAt,
      createdAt: createdAt ?? this.createdAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($IndexingTestCategoryTableTable
          .$convertersyncStatus
          .toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('IndexingTestCategoryTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('lastSyncedAt: $lastSyncedAt, ')
          ..write('createdAt: $createdAt, ')
...
class $InvalidProductTableTable extends InvalidProductTable
    with TableInfo<$InvalidProductTableTable, InvalidProduct> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $InvalidProductTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $InvalidProductTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, categoryId, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'invalid_products';
  @override
  VerificationContext validateIntegrity(Insertable<InvalidProduct> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  InvalidProduct map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return InvalidProduct.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  $InvalidProductTableTable createAlias(String alias) {
    return $InvalidProductTableTable(attachedDatabase, alias);
  }
...
class InvalidProductTableCompanion extends UpdateCompanion<InvalidProduct> {
  final Value<String> id;
  final Value<String> name;
  final Value<String> categoryId;
  final Value<DateTime?> lastSyncedAt;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const InvalidProductTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.categoryId = const Value.absent(),
    this.lastSyncedAt = const Value.absent(),
  ...
  InvalidProductTableCompanion.insert({
    required String id,
    required String name,
    required String categoryId,
    this.lastSyncedAt = const Value.absent(),
    ...
    this.rowid = const Value.absent(),
        ...
        name = Value(name),
        categoryId = Value(categoryId);
  static Insertable<InvalidProduct> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<String>? categoryId,
    Expression<DateTime>? lastSyncedAt,
  ...
  InvalidProductTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      Value<String>? categoryId,
      Value<DateTime?>? lastSyncedAt,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return InvalidProductTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      categoryId: categoryId ?? this.categoryId,
      lastSyncedAt: lastSyncedAt ?? this.lastSyncedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($InvalidProductTableTable
          .$convertersyncStatus
          .toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('InvalidProductTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('categoryId: $categoryId, ')
          ..write('lastSyncedAt: $lastSyncedAt, ')
...
class $TestUserTableTable extends TestUserTable
    with TableInfo<$TestUserTableTable, TestUser> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TestUserTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              requiredDuringInsert: false,
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>($TestUserTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, email, username, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'test_users';
  @override
  VerificationContext validateIntegrity(Insertable<TestUser> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TestUser map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TestUser.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      email: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}email'])!,
  ...
  @override
  $TestUserTableTable createAlias(String alias) {
    return $TestUserTableTable(attachedDatabase, alias);
  }
...
class TestUserTableCompanion extends UpdateCompanion<TestUser> {
  final Value<String> id;
  final Value<String> email;
  ...
  static Insertable<TestUser> custom({
    Expression<String>? id,
    Expression<String>? email,
  ...
  TestUserTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? email,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>(
          $TestUserTableTable.$convertersyncStatus.toSql(syncStatus.value));
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('TestUserTableCompanion(')
          ..write('id: $id, ')
          ..write('email: $email, ')
...
class $CategoryTableTable extends CategoryTable
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, color, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $ServerTestModelTableTable extends ServerTestModelTable
    with TableInfo<$ServerTestModelTableTable, ServerTestModel> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ServerTestModelTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $ServerTestModelTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, description, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'server_test_models';
  @override
  VerificationContext validateIntegrity(Insertable<ServerTestModel> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ServerTestModel map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ServerTestModel.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  $ServerTestModelTableTable createAlias(String alias) {
    return $ServerTestModelTableTable(attachedDatabase, alias);
  }
...
class ServerTestModelTableCompanion extends UpdateCompanion<ServerTestModel> {
  final Value<String> id;
  final Value<String> name;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const ServerTestModelTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
  ...
  ServerTestModelTableCompanion.insert({
    required String id,
    required String name,
  ...
  static Insertable<ServerTestModel> custom({
    Expression<String>? id,
    Expression<String>? name,
  ...
  ServerTestModelTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return ServerTestModelTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($ServerTestModelTableTable
          .$convertersyncStatus
          .toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('ServerTestModelTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
...
class $ClientTestModelTableTable extends ClientTestModelTable
    with TableInfo<$ClientTestModelTableTable, ClientTestModel> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ClientTestModelTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $ClientTestModelTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'client_test_models';
  @override
  VerificationContext validateIntegrity(Insertable<ClientTestModel> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ClientTestModel map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ClientTestModel.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  $ClientTestModelTableTable createAlias(String alias) {
    return $ClientTestModelTableTable(attachedDatabase, alias);
  }
...
class ClientTestModelTableCompanion extends UpdateCompanion<ClientTestModel> {
  final Value<String> id;
  final Value<String> name;
  final Value<DateTime?> lastSyncedAt;
  final Value<DateTime?> createdAt;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const ClientTestModelTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.lastSyncedAt = const Value.absent(),
    this.createdAt = const Value.absent(),
  ...
  ClientTestModelTableCompanion.insert({
    required String id,
    required String name,
    this.lastSyncedAt = const Value.absent(),
    this.createdAt = const Value.absent(),
    ...
    this.rowid = const Value.absent(),
        ...
        name = Value(name);
  static Insertable<ClientTestModel> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<DateTime>? lastSyncedAt,
    Expression<DateTime>? createdAt,
  ...
  ClientTestModelTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      Value<DateTime?>? lastSyncedAt,
      Value<DateTime?>? createdAt,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return ClientTestModelTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      lastSyncedAt: lastSyncedAt ?? this.lastSyncedAt,
      createdAt: createdAt ?? this.createdAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($ClientTestModelTableTable
          .$convertersyncStatus
          .toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('ClientTestModelTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('lastSyncedAt: $lastSyncedAt, ')
          ..write('createdAt: $createdAt, ')
...
class $ServerParentModelTableTable extends ServerParentModelTable
    with TableInfo<$ServerParentModelTableTable, ServerParentModel> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ServerParentModelTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $ServerParentModelTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, category, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'server_parent_models';
  @override
  VerificationContext validateIntegrity(Insertable<ServerParentModel> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ServerParentModel map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ServerParentModel.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  $ServerParentModelTableTable createAlias(String alias) {
    return $ServerParentModelTableTable(attachedDatabase, alias);
  }
...
class ServerParentModelTableCompanion
    extends UpdateCompanion<ServerParentModel> {
  final Value<String> id;
  final Value<String> name;
  final Value<String> category;
  final Value<DateTime?> lastSyncedAt;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const ServerParentModelTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.category = const Value.absent(),
    this.lastSyncedAt = const Value.absent(),
  ...
  ServerParentModelTableCompanion.insert({
    required String id,
    required String name,
  ...
  static Insertable<ServerParentModel> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<String>? category,
    Expression<DateTime>? lastSyncedAt,
  ...
  ServerParentModelTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      Value<String>? category,
      Value<DateTime?>? lastSyncedAt,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return ServerParentModelTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      category: category ?? this.category,
      lastSyncedAt: lastSyncedAt ?? this.lastSyncedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($ServerParentModelTableTable
          .$convertersyncStatus
          .toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('ServerParentModelTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('category: $category, ')
          ..write('lastSyncedAt: $lastSyncedAt, ')
...
class $ServerChildModelTableTable extends ServerChildModelTable
    with TableInfo<$ServerChildModelTableTable, ServerChildModel> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ServerChildModelTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $ServerChildModelTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns => [
        id,
        name,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'server_child_models';
  @override
  VerificationContext validateIntegrity(Insertable<ServerChildModel> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ServerChildModel map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ServerChildModel.fromDb(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
  ...
  @override
  $ServerChildModelTableTable createAlias(String alias) {
    return $ServerChildModelTableTable(attachedDatabase, alias);
  }
...
class ServerChildModelTableCompanion extends UpdateCompanion<ServerChildModel> {
  final Value<String> id;
  final Value<String> name;
  ...
  final Value<SyncStatus?> syncStatus;
  final Value<int> rowid;
  const ServerChildModelTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
  ...
  ServerChildModelTableCompanion.insert({
    required String id,
    required String name,
    ...
    this.rowid = const Value.absent(),
        ...
        data = Value(data);
  static Insertable<ServerChildModel> custom({
    Expression<String>? id,
    Expression<String>? name,
  ...
  ServerChildModelTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? name,
      ...
      Value<SyncStatus?>? syncStatus,
      Value<int>? rowid}) {
    return ServerChildModelTableCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>($ServerChildModelTableTable
          .$convertersyncStatus
          .toSql(syncStatus.value));
    }
    if (rowid.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('ServerChildModelTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
...
class $DepartmentTableTable extends DepartmentTable
    with TableInfo<$DepartmentTableTable, Department> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>(
              $DepartmentTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, companyId, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class DepartmentTableCompanion extends UpdateCompanion<Department> {
  final Value<String> id;
  final Value<String> name;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>(
          $DepartmentTableTable.$convertersyncStatus.toSql(syncStatus.value));
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class $ProjectTableTable extends ProjectTable
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              requiredDuringInsert: false,
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>($ProjectTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns => [
        id,
        name,
...
class ProjectTableCompanion extends UpdateCompanion<Project> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>(
          $ProjectTableTable.$convertersyncStatus.toSql(syncStatus.value));
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class $CompanyTableTable extends CompanyTable
  ...
  late final GeneratedColumnWithTypeConverter<SyncStatus?, String> syncStatus =
      GeneratedColumn<String>('sync_status', aliasedName, true,
              ...
              requiredDuringInsert: false,
              defaultValue: const Constant('synced'))
          .withConverter<SyncStatus?>($CompanyTableTable.$convertersyncStatus);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, departmentId, lastSyncedAt, createdAt, updatedAt, syncStatus];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class CompanyTableCompanion extends UpdateCompanion<Company> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncStatus.present) {
      map['sync_status'] = Variable<String>(
          $CompanyTableTable.$convertersyncStatus.toSql(syncStatus.value));
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
abstract class _$SynquillDatabase extends GeneratedDatabase {
  ...
  late final $IndexingTestProductTableTable indexingTestProductTable =
      $IndexingTestProductTableTable(this);
  late final $IndexingTestCategoryTableTable indexingTestCategoryTable =
      $IndexingTestCategoryTableTable(this);
  late final $InvalidProductTableTable invalidProductTable =
      $InvalidProductTableTable(this);
  late final $TestUserTableTable testUserTable = $TestUserTableTable(this);
  late final $CategoryTableTable categoryTable = $CategoryTableTable(this);
  late final $ServerTestModelTableTable serverTestModelTable =
      $ServerTestModelTableTable(this);
  late final $ClientTestModelTableTable clientTestModelTable =
      $ClientTestModelTableTable(this);
  late final $ServerParentModelTableTable serverParentModelTable =
      $ServerParentModelTableTable(this);
  late final $ServerChildModelTableTable serverChildModelTable =
      $ServerChildModelTableTable(this);
  ...
  late final Index idxContactsUserId = Index('idx_contacts_userId',
      'CREATE INDEX idx_contacts_userId ON contacts (user_id)');
  ...
  late final Index idxIndexingTestProductsCategoryId = Index(
      'idx_indexing_test_products_categoryId',
      'CREATE INDEX idx_indexing_test_products_categoryId ON indexing_test_products (category_id)');
  late final Index idxInvalidProductsCategoryId = Index(
      'idx_invalid_products_categoryId',
      'CREATE INDEX idx_invalid_products_categoryId ON invalid_products (category_id)');
  late final Index idxTestUsersEmail = Index('idx_test_users_email',
      'CREATE UNIQUE INDEX idx_test_users_email ON test_users (email)');
  late final Index idxTestUsersUsername = Index('idx_test_users_username',
      'CREATE INDEX idx_test_users_username ON test_users (username)');
  late final Index idxServerChildModelsParentId = Index(
      'idx_server_child_models_parentId',
      'CREATE INDEX idx_server_child_models_parentId ON server_child_models (parent_id)');
  late final Index idxDepartmentsCompanyId = Index('idx_departments_companyId',
      'CREATE INDEX idx_departments_companyId ON departments (company_id)');
  late final Index idxTodosUserId = Index(
      'idx_todos_userId', 'CREATE INDEX idx_todos_userId ON todos (user_id)');
  late final Index projectName = Index(
      'project_name', 'CREATE UNIQUE INDEX project_name ON projects (name)');
  late final Index idxProjectsOwnerId = Index('idx_projects_ownerId',
      'CREATE INDEX idx_projects_ownerId ON projects (owner_id)');
  late final Index idxProjectsCategoryId = Index('idx_projects_categoryId',
      'CREATE INDEX idx_projects_categoryId ON projects (category_id)');
  late final Index idxCompaniesDepartmentId = Index(
      'idx_companies_departmentId',
      'CREATE INDEX idx_companies_departmentId ON companies (department_id)');
  late final ContactDao contactDao = ContactDao(this as SynquillDatabase);
  ...
  late final IndexingTestProductDao indexingTestProductDao =
      IndexingTestProductDao(this as SynquillDatabase);
  late final IndexingTestCategoryDao indexingTestCategoryDao =
      IndexingTestCategoryDao(this as SynquillDatabase);
  late final InvalidProductDao invalidProductDao =
      InvalidProductDao(this as SynquillDatabase);
  late final TestUserDao testUserDao = TestUserDao(this as SynquillDatabase);
  late final CategoryDao categoryDao = CategoryDao(this as SynquillDatabase);
  late final ServerTestModelDao serverTestModelDao =
      ServerTestModelDao(this as SynquillDatabase);
  late final ClientTestModelDao clientTestModelDao =
      ClientTestModelDao(this as SynquillDatabase);
  late final ServerParentModelDao serverParentModelDao =
      ServerParentModelDao(this as SynquillDatabase);
  late final ServerChildModelDao serverChildModelDao =
      ServerChildModelDao(this as SynquillDatabase);
  late final DepartmentDao departmentDao =
      DepartmentDao(this as SynquillDatabase);
  late final TodoDao todoDao = TodoDao(this as SynquillDatabase);
  late final ProjectDao projectDao = ProjectDao(this as SynquillDatabase);
  late final CompanyDao companyDao = CompanyDao(this as SynquillDatabase);
  @override
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities => [
        ...
        idxIndexingTestProductsCategoryId,
        idxInvalidProductsCategoryId,
        idxTestUsersEmail,
        idxTestUsersUsername,
        idxServerChildModelsParentId,
        idxDepartmentsCompanyId,
        idxTodosUserId,
        projectName,
        idxProjectsOwnerId,
        idxProjectsCategoryId,
        idxCompaniesDepartmentId
      ];
}
...
typedef $$SyncQueueItemsTableProcessedTableManager = ProcessedTableManager<
    ...
    SyncQueueItem,
    PrefetchHooks Function()>;
typedef $$ContactTableTableCreateCompanionBuilder = ContactTableCompanion
    Function({
  Value<String?> importedContactId,
  required String userId,
  required String id,
...
typedef $$ContactTableTableUpdateCompanionBuilder = ContactTableCompanion
    Function({
  Value<String?> importedContactId,
  Value<String> userId,
  Value<String> id,
...
class $$ContactTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $ContactTableTable> {
  ...
  ColumnFilters<String> get importedContactId => $composableBuilder(
      column: $table.importedContactId,
      builder: (column) => ColumnFilters(column));
...
class $$ContactTableTableOrderingComposer
  ...
  ColumnOrderings<String> get importedContactId => $composableBuilder(
      column: $table.importedContactId,
      builder: (column) => ColumnOrderings(column));
...
class $$ContactTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get importedContactId => $composableBuilder(
      column: $table.importedContactId, builder: (column) => column);
...
class $$ContactTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $ContactTableTable,
    Contact,
    $$ContactTableTableFilterComposer,
    ...
    (Contact, BaseReferences<_$SynquillDatabase, $ContactTableTable, Contact>),
    Contact,
    PrefetchHooks Function()> {
  $$ContactTableTableTableManager(
      _$SynquillDatabase db, $ContactTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            Value<String?> importedContactId = const Value.absent(),
...
typedef $$ContactTableTableProcessedTableManager = ProcessedTableManager<
    _$SynquillDatabase,
    $ContactTableTable,
    Contact,
    $$ContactTableTableFilterComposer,
...
typedef $$UserTableTableProcessedTableManager = ProcessedTableManager<
    ...
    User,
    PrefetchHooks Function()>;
typedef $$IndexingTestProductTableTableCreateCompanionBuilder
    = IndexingTestProductTableCompanion Function({
  required String id,
  required String name,
  required String categoryId,
  Value<DateTime?> lastSyncedAt,
...
typedef $$IndexingTestProductTableTableUpdateCompanionBuilder
    = IndexingTestProductTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<String> categoryId,
...
class $$IndexingTestProductTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $IndexingTestProductTableTable> {
  $$IndexingTestProductTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IndexingTestProductTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $IndexingTestProductTableTable> {
  $$IndexingTestProductTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IndexingTestProductTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $IndexingTestProductTableTable> {
  $$IndexingTestProductTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IndexingTestProductTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $IndexingTestProductTableTable,
    IndexingTestProduct,
    $$IndexingTestProductTableTableFilterComposer,
    $$IndexingTestProductTableTableOrderingComposer,
    $$IndexingTestProductTableTableAnnotationComposer,
    $$IndexingTestProductTableTableCreateCompanionBuilder,
    $$IndexingTestProductTableTableUpdateCompanionBuilder,
    (
      IndexingTestProduct,
      BaseReferences<_$SynquillDatabase, $IndexingTestProductTableTable,
          IndexingTestProduct>
    ),
    IndexingTestProduct,
    PrefetchHooks Function()> {
  $$IndexingTestProductTableTableTableManager(
      _$SynquillDatabase db, $IndexingTestProductTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> rowid = const Value.absent(),
              ...
              IndexingTestProductTableCompanion(
            id: id,
            name: name,
...
typedef $$IndexingTestProductTableTableProcessedTableManager
    = ProcessedTableManager<
        ...
        IndexingTestProduct,
        PrefetchHooks Function()>;
typedef $$IndexingTestCategoryTableTableCreateCompanionBuilder
    = IndexingTestCategoryTableCompanion Function({
  required String id,
  required String name,
  Value<DateTime?> lastSyncedAt,
  Value<DateTime?> createdAt,
...
typedef $$IndexingTestCategoryTableTableUpdateCompanionBuilder
    = IndexingTestCategoryTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<DateTime?> lastSyncedAt,
...
class $$IndexingTestCategoryTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $IndexingTestCategoryTableTable> {
  $$IndexingTestCategoryTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IndexingTestCategoryTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $IndexingTestCategoryTableTable> {
  $$IndexingTestCategoryTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IndexingTestCategoryTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $IndexingTestCategoryTableTable> {
  $$IndexingTestCategoryTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IndexingTestCategoryTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $IndexingTestCategoryTableTable,
    IndexingTestCategory,
    $$IndexingTestCategoryTableTableFilterComposer,
    $$IndexingTestCategoryTableTableOrderingComposer,
    $$IndexingTestCategoryTableTableAnnotationComposer,
    $$IndexingTestCategoryTableTableCreateCompanionBuilder,
    $$IndexingTestCategoryTableTableUpdateCompanionBuilder,
    (
      IndexingTestCategory,
      BaseReferences<_$SynquillDatabase, $IndexingTestCategoryTableTable,
          IndexingTestCategory>
    ),
    IndexingTestCategory,
    PrefetchHooks Function()> {
  $$IndexingTestCategoryTableTableTableManager(
      _$SynquillDatabase db, $IndexingTestCategoryTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> rowid = const Value.absent(),
              ...
              IndexingTestCategoryTableCompanion(
            id: id,
            name: name,
            lastSyncedAt: lastSyncedAt,
            createdAt: createdAt,
...
typedef $$IndexingTestCategoryTableTableProcessedTableManager
    = ProcessedTableManager<
        _$SynquillDatabase,
        $IndexingTestCategoryTableTable,
        IndexingTestCategory,
        ...
        IndexingTestCategory,
        PrefetchHooks Function()>;
typedef $$InvalidProductTableTableCreateCompanionBuilder
    = InvalidProductTableCompanion Function({
  required String id,
  required String name,
  required String categoryId,
  Value<DateTime?> lastSyncedAt,
...
typedef $$InvalidProductTableTableUpdateCompanionBuilder
    = InvalidProductTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<String> categoryId,
...
class $$InvalidProductTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $InvalidProductTableTable> {
  $$InvalidProductTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$InvalidProductTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $InvalidProductTableTable> {
  $$InvalidProductTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$InvalidProductTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $InvalidProductTableTable> {
  $$InvalidProductTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$InvalidProductTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $InvalidProductTableTable,
    InvalidProduct,
    $$InvalidProductTableTableFilterComposer,
    $$InvalidProductTableTableOrderingComposer,
    $$InvalidProductTableTableAnnotationComposer,
    $$InvalidProductTableTableCreateCompanionBuilder,
    $$InvalidProductTableTableUpdateCompanionBuilder,
    (
      InvalidProduct,
      BaseReferences<_$SynquillDatabase, $InvalidProductTableTable,
          InvalidProduct>
    ),
    InvalidProduct,
    PrefetchHooks Function()> {
  $$InvalidProductTableTableTableManager(
      _$SynquillDatabase db, $InvalidProductTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$InvalidProductTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$InvalidProductTableTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$InvalidProductTableTableProcessedTableManager = ProcessedTableManager<
    _$SynquillDatabase,
    $InvalidProductTableTable,
    InvalidProduct,
    $$InvalidProductTableTableFilterComposer,
    ...
    InvalidProduct,
    PrefetchHooks Function()>;
typedef $$TestUserTableTableCreateCompanionBuilder = TestUserTableCompanion
    Function({
  required String id,
  required String email,
  required String username,
...
typedef $$TestUserTableTableUpdateCompanionBuilder = TestUserTableCompanion
    Function({
  Value<String> id,
  Value<String> email,
  Value<String> username,
...
class $$TestUserTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $TestUserTableTable> {
  $$TestUserTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TestUserTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $TestUserTableTable> {
  $$TestUserTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TestUserTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $TestUserTableTable> {
  $$TestUserTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TestUserTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $TestUserTableTable,
    TestUser,
    $$TestUserTableTableFilterComposer,
    $$TestUserTableTableOrderingComposer,
    $$TestUserTableTableAnnotationComposer,
    $$TestUserTableTableCreateCompanionBuilder,
    $$TestUserTableTableUpdateCompanionBuilder,
    (
      TestUser,
      BaseReferences<_$SynquillDatabase, $TestUserTableTable, TestUser>
    ),
    TestUser,
    PrefetchHooks Function()> {
  $$TestUserTableTableTableManager(
      _$SynquillDatabase db, $TestUserTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TestUserTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TestUserTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TestUserTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> email = const Value.absent(),
...
typedef $$TestUserTableTableProcessedTableManager = ProcessedTableManager<
    _$SynquillDatabase,
    $TestUserTableTable,
    TestUser,
    $$TestUserTableTableFilterComposer,
...
class $$CategoryTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $CategoryTableTable> {
...
class $$CategoryTableTableTableManager extends RootTableManager<
    ...
    (
      Category,
      BaseReferences<_$SynquillDatabase, $CategoryTableTable, Category>
    ),
    Category,
    PrefetchHooks Function()> {
  $$CategoryTableTableTableManager(
      _$SynquillDatabase db, $CategoryTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$CategoryTableTableProcessedTableManager = ProcessedTableManager<
    ...
    Category,
    PrefetchHooks Function()>;
typedef $$ServerTestModelTableTableCreateCompanionBuilder
    = ServerTestModelTableCompanion Function({
  required String id,
  required String name,
  required String description,
  Value<DateTime?> lastSyncedAt,
...
typedef $$ServerTestModelTableTableUpdateCompanionBuilder
    = ServerTestModelTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<String> description,
...
class $$ServerTestModelTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $ServerTestModelTableTable> {
  $$ServerTestModelTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerTestModelTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $ServerTestModelTableTable> {
  $$ServerTestModelTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerTestModelTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $ServerTestModelTableTable> {
  $$ServerTestModelTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerTestModelTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $ServerTestModelTableTable,
    ServerTestModel,
    $$ServerTestModelTableTableFilterComposer,
    $$ServerTestModelTableTableOrderingComposer,
    $$ServerTestModelTableTableAnnotationComposer,
    $$ServerTestModelTableTableCreateCompanionBuilder,
    $$ServerTestModelTableTableUpdateCompanionBuilder,
    (
      ServerTestModel,
      BaseReferences<_$SynquillDatabase, $ServerTestModelTableTable,
          ServerTestModel>
    ),
    ServerTestModel,
    PrefetchHooks Function()> {
  $$ServerTestModelTableTableTableManager(
      _$SynquillDatabase db, $ServerTestModelTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ServerTestModelTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ServerTestModelTableTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$ServerTestModelTableTableProcessedTableManager
    = ProcessedTableManager<
        _$SynquillDatabase,
        $ServerTestModelTableTable,
        ServerTestModel,
        ...
        ServerTestModel,
        PrefetchHooks Function()>;
typedef $$ClientTestModelTableTableCreateCompanionBuilder
    = ClientTestModelTableCompanion Function({
  required String id,
  required String name,
  Value<DateTime?> lastSyncedAt,
  Value<DateTime?> createdAt,
...
typedef $$ClientTestModelTableTableUpdateCompanionBuilder
    = ClientTestModelTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<DateTime?> lastSyncedAt,
...
class $$ClientTestModelTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $ClientTestModelTableTable> {
  $$ClientTestModelTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ClientTestModelTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $ClientTestModelTableTable> {
  $$ClientTestModelTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ClientTestModelTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $ClientTestModelTableTable> {
  $$ClientTestModelTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ClientTestModelTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $ClientTestModelTableTable,
    ClientTestModel,
    $$ClientTestModelTableTableFilterComposer,
    $$ClientTestModelTableTableOrderingComposer,
    $$ClientTestModelTableTableAnnotationComposer,
    $$ClientTestModelTableTableCreateCompanionBuilder,
    $$ClientTestModelTableTableUpdateCompanionBuilder,
    (
      ClientTestModel,
      BaseReferences<_$SynquillDatabase, $ClientTestModelTableTable,
          ClientTestModel>
    ),
    ClientTestModel,
    PrefetchHooks Function()> {
  $$ClientTestModelTableTableTableManager(
      _$SynquillDatabase db, $ClientTestModelTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ClientTestModelTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ClientTestModelTableTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$ClientTestModelTableTableProcessedTableManager
    = ProcessedTableManager<
        _$SynquillDatabase,
        $ClientTestModelTableTable,
        ClientTestModel,
        ...
        ClientTestModel,
        PrefetchHooks Function()>;
typedef $$ServerParentModelTableTableCreateCompanionBuilder
    = ServerParentModelTableCompanion Function({
  required String id,
  required String name,
  required String category,
  Value<DateTime?> lastSyncedAt,
...
typedef $$ServerParentModelTableTableUpdateCompanionBuilder
    = ServerParentModelTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<String> category,
...
class $$ServerParentModelTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $ServerParentModelTableTable> {
  $$ServerParentModelTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerParentModelTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $ServerParentModelTableTable> {
  $$ServerParentModelTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerParentModelTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $ServerParentModelTableTable> {
  $$ServerParentModelTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerParentModelTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $ServerParentModelTableTable,
    ServerParentModel,
    $$ServerParentModelTableTableFilterComposer,
    $$ServerParentModelTableTableOrderingComposer,
    $$ServerParentModelTableTableAnnotationComposer,
    $$ServerParentModelTableTableCreateCompanionBuilder,
    $$ServerParentModelTableTableUpdateCompanionBuilder,
    (
      ServerParentModel,
      BaseReferences<_$SynquillDatabase, $ServerParentModelTableTable,
          ServerParentModel>
    ),
    ServerParentModel,
    PrefetchHooks Function()> {
  $$ServerParentModelTableTableTableManager(
      _$SynquillDatabase db, $ServerParentModelTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> rowid = const Value.absent(),
              ...
              ServerParentModelTableCompanion(
            id: id,
            name: name,
            category: category,
            lastSyncedAt: lastSyncedAt,
...
typedef $$ServerParentModelTableTableProcessedTableManager
    = ProcessedTableManager<
        _$SynquillDatabase,
        $ServerParentModelTableTable,
        ServerParentModel,
        ...
        ServerParentModel,
        PrefetchHooks Function()>;
typedef $$ServerChildModelTableTableCreateCompanionBuilder
    = ServerChildModelTableCompanion Function({
  required String id,
  required String name,
  required String parentId,
  required String data,
...
typedef $$ServerChildModelTableTableUpdateCompanionBuilder
    = ServerChildModelTableCompanion Function({
  Value<String> id,
  Value<String> name,
  Value<String> parentId,
...
class $$ServerChildModelTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $ServerChildModelTableTable> {
  $$ServerChildModelTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerChildModelTableTableOrderingComposer
    extends Composer<_$SynquillDatabase, $ServerChildModelTableTable> {
  $$ServerChildModelTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerChildModelTableTableAnnotationComposer
    extends Composer<_$SynquillDatabase, $ServerChildModelTableTable> {
  $$ServerChildModelTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ServerChildModelTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    $ServerChildModelTableTable,
    ServerChildModel,
    $$ServerChildModelTableTableFilterComposer,
    $$ServerChildModelTableTableOrderingComposer,
    $$ServerChildModelTableTableAnnotationComposer,
    $$ServerChildModelTableTableCreateCompanionBuilder,
    $$ServerChildModelTableTableUpdateCompanionBuilder,
    (
      ServerChildModel,
      BaseReferences<_$SynquillDatabase, $ServerChildModelTableTable,
          ServerChildModel>
    ),
    ServerChildModel,
    PrefetchHooks Function()> {
  $$ServerChildModelTableTableTableManager(
      _$SynquillDatabase db, $ServerChildModelTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> rowid = const Value.absent(),
              ...
              ServerChildModelTableCompanion(
            id: id,
            name: name,
            parentId: parentId,
            data: data,
...
typedef $$ServerChildModelTableTableProcessedTableManager
    = ProcessedTableManager<
        _$SynquillDatabase,
        $ServerChildModelTableTable,
        ServerChildModel,
        ...
        ServerChildModel,
        PrefetchHooks Function()>;
typedef $$DepartmentTableTableCreateCompanionBuilder = DepartmentTableCompanion
    Function({
  required String id,
  required String name,
  required String companyId,
...
typedef $$DepartmentTableTableUpdateCompanionBuilder = DepartmentTableCompanion
    Function({
  Value<String> id,
  Value<String> name,
  Value<String> companyId,
...
class $$DepartmentTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $DepartmentTableTable> {
...
class $$DepartmentTableTableTableManager extends RootTableManager<
    _$SynquillDatabase,
    ...
    (
      Department,
      BaseReferences<_$SynquillDatabase, $DepartmentTableTable, Department>
    ),
    Department,
    PrefetchHooks Function()> {
  $$DepartmentTableTableTableManager(
      _$SynquillDatabase db, $DepartmentTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$DepartmentTableTableProcessedTableManager = ProcessedTableManager<
    _$SynquillDatabase,
    $DepartmentTableTable,
    Department,
    $$DepartmentTableTableFilterComposer,
...
class $$ProjectTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $ProjectTableTable> {
...
class $$ProjectTableTableTableManager extends RootTableManager<
    ...
    (Project, BaseReferences<_$SynquillDatabase, $ProjectTableTable, Project>),
    Project,
    PrefetchHooks Function()> {
  $$ProjectTableTableTableManager(
      _$SynquillDatabase db, $ProjectTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$CompanyTableTableFilterComposer
    extends Composer<_$SynquillDatabase, $CompanyTableTable> {
...
class $$CompanyTableTableTableManager extends RootTableManager<
    ...
    (Company, BaseReferences<_$SynquillDatabase, $CompanyTableTable, Company>),
    Company,
    PrefetchHooks Function()> {
  $$CompanyTableTableTableManager(
      _$SynquillDatabase db, $CompanyTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $SynquillDatabaseManager {
  ...
  $$IndexingTestProductTableTableTableManager get indexingTestProductTable =>
      $$IndexingTestProductTableTableTableManager(
          _db, _db.indexingTestProductTable);
  $$IndexingTestCategoryTableTableTableManager get indexingTestCategoryTable =>
      $$IndexingTestCategoryTableTableTableManager(
          _db, _db.indexingTestCategoryTable);
  $$InvalidProductTableTableTableManager get invalidProductTable =>
      $$InvalidProductTableTableTableManager(_db, _db.invalidProductTable);
  $$TestUserTableTableTableManager get testUserTable =>
      $$TestUserTableTableTableManager(_db, _db.testUserTable);
  $$CategoryTableTableTableManager get categoryTable =>
      $$CategoryTableTableTableManager(_db, _db.categoryTable);
  $$ServerTestModelTableTableTableManager get serverTestModelTable =>
      $$ServerTestModelTableTableTableManager(_db, _db.serverTestModelTable);
  $$ClientTestModelTableTableTableManager get clientTestModelTable =>
      $$ClientTestModelTableTableTableManager(_db, _db.clientTestModelTable);
  $$ServerParentModelTableTableTableManager get serverParentModelTable =>
      $$ServerParentModelTableTableTableManager(
          _db, _db.serverParentModelTable);
  $$ServerChildModelTableTableTableManager get serverChildModelTable =>
      $$ServerChildModelTableTableTableManager(_db, _db.serverChildModelTable);
